...
CPPPATH_DNS_SD = ['/usr/local/include']
CPPPATH_NODE = '/usr/local/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g', '-arch', 'i386', '-arch', 'x86_64']
CXXFLAGS_DEBUG = ['-g']
...
HAVE_DNSSERVICEGETADDRINFO = 1
HAVE_DNS_SD_H = 1
LIBDIR = '/Users/neil/node_modules/.bin'
LIBPATH_NODE = '/usr/local/lib'
LIBPATH_ST = '-L%s'
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup', '-arch', 'i386', '-arch', 'x86_64']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/Users/neil/node_modules/.bin'
PREFIX = '/usr/local'
...
STATICLIB_MARKER = ''
STATICLIB_ST = '-l%s'
defines = {'HAVE_DNS_SD_H': 1, 'HAVE_DNSSERVICEGETADDRINFO': 1}
